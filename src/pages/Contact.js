...
const Contact = () => {
    return (
        <div id="contact">
            ...
            <div ><br/>
                <h1 class="text-center" style={{color: "white; !important", paddingTop: "100px;"}}>Contact Us</h1>
            </div>
            <br/><br/>
            <div class="container">
                <div class="row">
                ...
                <div class="col-md-4">
                    <div class="wrimagecard card wrimagecard-topimage">
                        <div class="wrimagecard-topimage_header">
                            <center><i class="fa fa-phone" style={{color:"white"}}></i></center>
                        </div>
                        <br/>
                        <center>
                ...
                <div class="col-md-4">
                    <div class="wrimagecard card wrimagecard-topimage">
                        <div class="wrimagecard-topimage_header" >
                            <center><i class="fa fa-map-marker" style={{color:"white"}}> </i></center>
                        </div>
                        <br/>
                        <center>
        ...
        <div class="row">
                ...
                <div class="wrap-contact100">
                    <form class="contact100-form validate-form">
                        ...
                        <div class="wrap-input100">
                            ...
                            <input class="input100" type="text" name="web" placeholder="This Message is For..."></input>
                        </div>
            ...
            <div class="col-lg-5">
                <iframe
                    ...
                    width="85%" height="62%" style={{border:"5px" ,borderRadius: "15px"}} class="mapmedi" allowfullscreen=""
                    loading="lazy"></iframe>
            </div>
        </div>
        </div>
